...
const Navbar = () => {
  ...
  return (
    <>
      <nav 
      ref={navRef}
      className={`fixed top-0 left-0 w-full z-[100] transition-all duration-500 py-6 px-6 sm:px-12 ${
        isScrolled 
    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        {/* Logo */}
        <Link to="/" className="text-xl sm:text-2xl font-black tracking-tighter text-white flex items-center gap-1 group">
          SKYDREAMIX
          <span className="w-1.5 h-1.5 bg-accent-1 rounded-full group-hover:animate-ping" />
        </Link>
